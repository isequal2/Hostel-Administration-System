...
<body>
	...
	<table>
	<tr>
<td><a class="st" href="authority.php">Home</a></td>
	<td><a class="st" href="mess_authority.php">Mess</a></td>
	<td><a class="st_opted" href="complaint_authority.php">Complaint</a></td>
	...
	<tr>
		...
		<td ><h3>New Complaints</h3>
			<?php
				...
				echo "<form method='post' action='complaint_handle.php'>";
				...
				echo "<td>".$row['SID']."</td>";
				echo "<td><input type='TEXT' name='$m' id='$m' placeholder='1-5 only numbers' /></td>";
				echo "</tr>";
