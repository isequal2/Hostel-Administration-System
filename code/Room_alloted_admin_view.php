...
var myurl = 'fetch_search_result.php';
var one=document.getElementById('search');
//alert("hi");
var sem=one.value;
...
<body>
	...
	<td><a class="st_opted" href="Room_alloted_admin_view.php">Room</a></td>
	...
	<td>
			...
			session_start();
				...
				$username=$_SESSION['usernamee'];
					...
					echo "<table>";
					echo "<tr><td><input type='text' id='search' name='search'/></td>";
					echo "<td><button class='submit' onClick='showData()' value='submit'>Submit</button></td></tr>";
