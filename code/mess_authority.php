...
<body>
	...
	<td><a class="st_opted" href="mess_authority.php">Mess</a></td>
	<td><a class="st" href="complaint_authority.php">Complaint</a></td>
			...
			session_start();
				...
				$username=$_SESSION['usernamee'];
					...
					while($row=mysqli_fetch_array($result))
					{
						...
						echo "<option value='Block ".$x." Mess'>".$temp."</option>";
